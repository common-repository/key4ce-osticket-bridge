...
$user_id=$ost_wpdb->get_var("SELECT user_id FROM " . $keyost_prefix . "user_email WHERE `address` = '" . $current_user->user_email . "'");
    ...
    <div id="key4ce_new_ticket">
        ...
        <form id="ticketForm" name="newticket" method="post" enctype="multipart/form-data" onsubmit="return validateFormNewTicket();">
            ...
            <div><input class="ost" id="cur-name" type="text" name="cur-name" readonly="true" style="width:90%" value="<?php echo $current_user->user_login; ?>"></div>
            </div>
			<div class="rightcol">
			<div class="contact_title"><?php echo __('Your Email','key4ce-osticket-bridge'); ?>:</div>
            <div><input class="ost" id="email" type="text" name="email" readonly="true" style="width:90%" value="<?php echo $current_user->user_email; ?>"></div>
           </div></div>
		   <div class="fullcol">
		   <div class="leftcol">
            <div class="contact_title"><?php echo __('Subject','key4ce-osticket-bridge'); ?>: <font class="key4ce_error">&nbsp;*</font></div>
            <div><input class="ost" id="subject" type="text" name="subject" style="width:90%" /></div>
			</div>
			<div class="rightcol">
				<div class="contact_title"><?php echo __('Priority','key4ce-osticket-bridge'); ?>: <font class="key4ce_error">&nbsp;*</font></div>
				<div><select id="priority" style="width:90%" name="priorityId">
		   ...
		   <div class="fullcol">
			<div class="leftcol">
			<div class="contact_title"><?php echo __('Catagories','key4ce-osticket-bridge'); ?>: <font class="key4ce_error">&nbsp;*</font></div>
            <div>
                <select id="deptId" style="width:90%" name="deptId">
			...
			<div id="key4ce_new_ticket_helptopic_loader" style="display:none;text-align: center;">
			...
			<div id="key4ce_new_ticket_helptopic" class="contact_title" style="display:none;"><?php echo __('Help Topic','key4ce-osticket-bridge'); ?>:</div>
