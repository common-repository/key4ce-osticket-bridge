...
Get your own advanced ticket system in Wordpress and Integrate osTicket into your wordpress site. Works with osTicket 1.9.3 - 1.10

== Description ==
= This project is no longer under development: =
Due to the osTicket versions always changing basic database aspects we felt it was simply not stable enough to be used in production.
It simply takes too much time and effort to keep up with all the recodes on each version and too many bugs pop up as a result of it.
We have therefor moved on to a different ticketing system and developed different portal plugin for it. (we have not yet made this portal public but might do so in the future).
If you’re interested in taking over development for this plugin please contact us.
...
= Basic Features: =
* Compatible with osTicket 1.9.3 - 1.10.
...
* Admin internal notes from osTicket.
* Admin Canned responses from osTicket.
...
* Make sure that your osTicket version is 1.9.3 to 1.9.14, and v1.10  (all subversions should work).
...
osTicket v1.9.3 to v1.10 (all subversions are generally supported).
...
- Added canned responses to admin
- Added responsive design to admin section
- Added responsive design to client section
- Added Wordpress avatars
- Re-designed contact page, ticket page, and more.
- Added v1.10+ support

Added to professional version:
- osTicket knowledgebase sync with wordpress custom taxonomy
- Select departments per wordpress site
- more to come soon...
...
== Upgrade Notice ==
= 1.4.0 = 
Major update version, overhaul on layout and many new functions! also added osticket v1.10 support
